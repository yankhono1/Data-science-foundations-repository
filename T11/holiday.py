# Define the function calculate_hotel_cost creating hotel_cost as an argument
...
# Define the function calculate_car_rental creating car_rental as an argument
...
# plane_cost is created as a dictionary 
city_flight = input("Please enter the city you will be travelling to for your ticket (Tokyo, Lagos, Paris, New York): ").capitalize()

# Dictionary containing the price of each flight assuming it is only one ticket being bought
